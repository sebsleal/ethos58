...
import { parseCsv, num, lambdaToAfr } from './csvParser.js';
 ...
 */
export function analyzeLog(csvBuffer, filename, carDetails = {}) {
  const { rows, columns, timingColumns, boostUnit } = parseCsv(csvBuffer);
